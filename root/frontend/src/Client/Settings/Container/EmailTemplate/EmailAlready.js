...
import { addEmailAlreadyForm } from '../../../../Redux/actions/Client/PanelActions';

class EmailAlready extends Component {
    state = {
        textfield: [
            {
                id: 0,
    ...
    isFormValid = (event) => {
        ...
        if (isValid) {
            ...
            this.props.addEmailAlreadyForm(data);    
        }
        return isValid;
    }
    render() {
...
const mapStateToProps = (state) => ({
    isaddEmailAlreadyAdded: state.client.panel.isaddEmailAlreadyAdded,
})
