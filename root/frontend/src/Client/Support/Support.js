...
import {supportAndIssueInfo, getUserIssues} from "../../Redux/actions/Client/profile";
import Modal from "../../Reusuable/Container/Modal/Modal";
import Table from "../../Reusuable/Container/Table/Table";
class Support extends Component {
    ...
    isFormValid = (event) => {
        ...
        if (isValid) {
            ...
            data.append("issue", this.state.dropDown[0].value);
            data.append("textfield", this.state.textarea.value);
...
const mapStateToProps = (state) => ({
    isSupportAndIssueUpdated: state.client.profile.isSupportAndIssueUpdated,
    getSupportAndIssue: state.client.profile.getSupportAndIssue
})
